...
class NotificationViewController: UIViewController{
    ...
    func getNotifications (){
        ...
        var query2 = PFQuery.orQueryWithSubqueries([q1, query])
        query2.includeKey("toUser")
        query2.includeKey("fromUser")
        query2.orderByDescending("createdAt")
        query2.findObjectsInBackgroundWithBlock { (requests, error) -> Void in
...
extension NotificationViewController: UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        self.allRequests[indexPath.row].saveInBackground()
